...
curl_setopt($ch, CURLOPT_COOKIEJAR, 'cookie.txt'); // Сохранять куки
curl_setopt($ch, CURLOPT_COOKIEFILE, 'cookie.txt'); // Использовать куки
...
// Выполнение первого запроса для установки куки
...
// Повторный запрос с установленными куками
$ch = curl_init();
